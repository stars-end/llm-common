...
from llm_common.agents.schemas import AgentError, AgentStory, StoryResult
...
async def test_exclude_stories_filtering():
    with patch("llm_common.agents.uismoke_runner.load_stories_from_directory") as mock_load:
        ...
        with patch("os.environ.get", return_value="key"), \
             patch("llm_common.agents.uismoke_runner.GLMVisionClient") as mock_glm, \
             ...
             mock_glm.return_value.close = AsyncMock()
